...
# SRC = main.c \
# 		debugin.c \
# 	  lexer/lexer_init.c lexer/lexer_special_handler.c lexer/lexer_utils.c \
# 	  lexer/lexer_word_handler.c \
# 	  check_syntax/syntax_check_utils.c check_syntax/helper.c check_syntax/check_syntax.c \
# 	  check_syntax/redirectoin_error.c \
# 	  parser/handle_redirections.c parser/handle_heredoc.c parser/parser_utils.c \
# 	  parser/parser.c \
# 	  clean_up/ft_clean.c \
# 	  execution/exec_env.c \
# 	  expand/evn.c 
